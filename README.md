...
**Status: phase 1 (parser prototype).** A command line tool that turns photos,
scans and PDFs of layout sheets into straightened pages, debug overlays and JSON.
The desktop UI comes in phase 3.
...
page 1, and every `Notch:` line is matched to the right shelf.
...
2. Search logic with unit tests
